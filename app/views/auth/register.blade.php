...
<div class="content-container">
            ...
            <div class="contact_details">
             {{Form::open(['route' => 'frontend.auth.register'])}}
                ...
                {{Form::input('date', 'bday', ['max' => '1979-12-31'])}}
                
                {{Form::label('gender','Gender')}}
                {{Form::input('radio', 'gender','male' ['class' => 'radio_con radio'],array('checked'))}}
                {{Form::input('radio', 'gender','female' ['class' => 'radio_con radio'])}}                
